...
`);
  ...
  const copyHooks = () => {
    ...
    // Ensure hooks always run as CommonJS regardless of the project's module type.
    fs.copyFileSync(path.join(HOOKS_PKG, "package.json"), path.join(HOOKS_DST, "package.json"));
  };
